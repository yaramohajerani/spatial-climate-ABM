...
This writes a JSON file containing `sector_coefficients`, `input_recipe_ranges`,
...
Asia. The Natural Earth shapefile (`data/ne_110m_admin_0_countries/`) is already
in the repository and is used automatically as the land mask.
