...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # --- hazard ---
    haz = p.add_argument_group("hazard events (optional)")
    haz.add_argument(
...
def main(argv: list[str] | None = None) -> None:
    ...
    # --- simulation settings ---
    start_year = args.start_year or _start_year_from_calibration(cal)
    steps_per_year = args.steps_per_year
    steps = args.steps or (20 * steps_per_year)  # default 20 years
    ...
    params: dict = {
        "_comment": (
            ...
            "Add rp_files or raster_hazard_events for a hazard scenario."
        ),
    ...
    if args.rp_files:
        print(f"  rp_files:           {len(args.rp_files)} event(s)")
    print()
