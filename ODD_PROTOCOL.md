...
- `backup_suppliers`: continuity capital enables emergency purchases from non-primary suppliers,
...
Under `backup_suppliers`, a hazard-affected firm with positive continuity capital can search for non-primary suppliers in the same supplier sectors.
